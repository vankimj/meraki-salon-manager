...
export function blankService() {
  return { name: '', category: 'Manicures', basePrice: 0, priceFrom: true, duration: 30, durationMin: false, turnValue: null, description: '', image: '', active: true, taxable: true, sortOrder: 99, options: [], addOnServiceIds: [], defaultRebookWeeks: 0 };
}
