  ...
  },
  {
    ...
    items: [
      { id: 'capture-ein', flavor: FLAVORS.CAPTURE, risk: 'high',
        ...
        deepLink: { kind: 'admin', tab: 'settings' }, autoStatus: 'einCaptured', capture: { kind: 'ein' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'capture-socials', flavor: FLAVORS.CAPTURE,
        ...
        deepLink: { kind: 'admin', tab: 'webfront' }, autoStatus: 'socialsAdded', capture: { kind: 'socials' },
  ...
  },
  {
    ...
    items: [
      { id: 'salon-photos', flavor: FLAVORS.CAPTURE,
        ...
        deepLink: { kind: 'admin', tab: 'webfront' }, autoStatus: 'portfolioAdded', capture: { kind: 'portfolio' },
