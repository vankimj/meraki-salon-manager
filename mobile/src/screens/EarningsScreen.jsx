...
// Phase 2 will port src/modules/earnings/TechEarnings.jsx.
// For now: stub so the Earnings tab renders without crashing.
    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <View style={styles.card}>
        ...
        <Text style={styles.body}>
          Your tips, services, and take-home pay will live here.
        </Text>
        <View style={styles.tag}>
          <Text style={styles.tagText}>Coming in the next update</Text>
        </View>
      </View>
    </ScrollView>
  );
